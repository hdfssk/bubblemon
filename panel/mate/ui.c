...
/*
 * This file contains the MATE ui for bubblemon. It has been
 * adapted from the gnome3/ui.c code.
 *
 */
		      ...
		      gpointer data)
{
  ...
  gtk_show_about_dialog (NULL,
			 "version",            VERSION,
			 "copyright",          "Copyright (C) 1999-2014 Johan Walles",
...
static gboolean
bubblemon_applet_fill(BubblemonApplet *bubblemon_applet, MatePanelApplet *applet)
{
  ...
  mate_panel_applet_setup_menu_from_file(MATE_PANEL_APPLET(bubblemon_applet->applet), uiPath, actionGroup);
  g_free(uiPath);
...
static gboolean
bubble_applet_factory (MatePanelApplet *panel_applet,
		       const gchar *iid,
		       gpointer     data)
{
...
MATE_PANEL_APPLET_OUT_PROCESS_FACTORY ("BubblemonAppletFactory",
				       PANEL_TYPE_APPLET,
				       "BubblemonApplet",
